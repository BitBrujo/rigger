...
export default function AgentTester() {
  ...
  const handleLoadPreset = async (preset: Preset) => {
    ...
    const loadedConfig: AgentSDKConfig = {
      ...
      permissionMode: preset.permission_mode as 'default' | 'acceptEdits' | 'bypassPermissions' | 'plan',
      allowDangerouslySkipPermissions: preset.allow_dangerous_skip_permissions,
      ...
      env: preset.environment_vars,
      executable: preset.executable as 'node' | 'bun' | 'deno' | undefined,
